...
class CustomerPhoneTest extends TestCase
{
    ...
    public function testCustomerHasPhoneNumber(): void
    {
    ...
    public function testACustomerHasAPhoneNumber(): void
    {
        $customer = new Customer();

        $customer->setPhone('(234) 987654321');

        $this->assertAttributeEquals('(234) 987654321', 'phone', $customer);
    }
